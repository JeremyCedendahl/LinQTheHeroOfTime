...
namespace LINQ
{
    class Program
    {
        ...
        {
            //var classNr1 = new Klass { KlassNamn = "1A"};
            //var classNr2 = new Klass { KlassNamn = "1B"};




            //var stud1 = new Student {FullName = "Jeremy Cedendahl" , KlassId = 3};
            //var stud2 = new Student {FullName = "Johan Larsson", KlassId = 3 };
            //var stud3 = new Student {FullName = "Malin Blank", KlassId = 4};
            ...
            //var kursProg1 = new Kurs { Namn = "Programming1", TeacherID = 7 };
            //var kursProg2 = new Kurs { Namn = "Programmering2", TeacherID = 8 };

            //var stuKurs = new StudentKurs { KursId = 3, StudentID = 5};
            //var stuKurs2 = new StudentKurs { KursId = 3, StudentID = 6};
            //var stuKurs3 = new StudentKurs { KursId = 4, StudentID = 7};
            //var stuKurs4 = new StudentKurs { KursId = 4, StudentID = 8};
